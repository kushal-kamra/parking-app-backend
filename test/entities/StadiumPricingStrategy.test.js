...
describe("StadiumPricingStrategy Class", () => {
    it("Check StadiumPricingStrategy for 2wheeler + 5 hours", async () => {
        ...
        const fees = StadiumPricingStrategy.calculateFees(date5HoursBefore, VehicleCategory[0]);
    ...
    it("Check StadiumPricingStrategy for 2wheeler + 3 hours", async () => {
        ...
        const fees = StadiumPricingStrategy.calculateFees(date3HoursBefore, VehicleCategory[0]);
    ...
    it("Check StadiumPricingStrategy for 2wheeler + 14 hours", async () => {
        ...
        const fees = StadiumPricingStrategy.calculateFees(date14HoursBefore, VehicleCategory[0]);
    ...
    it("Check StadiumPricingStrategy for 4wheeler-light + 5 hours", async () => {
        // const stadiumPricing = new StadiumPricingStrategy();
        const date5HoursBefore = Date.now() - 18000000;
        const fees = StadiumPricingStrategy.calculateFees(date5HoursBefore, VehicleCategory[1]);
    ...
    it("Check StadiumPricingStrategy for 4wheeler-heavy", async () => {
        // const stadiumPricing = new StadiumPricingStrategy();
        const date5HoursBefore = Date.now() - 18000000;
        const fees = StadiumPricingStrategy.calculateFees(date5HoursBefore, VehicleCategory[2]);
    ...
    it("Check StadiumPricingStrategy passed in calculateFees is valid", async () => {
        expect(() => {
            ...
            // const stadiumPricing = new StadiumPricingStrategy();
            const date5HoursBefore = Date.now() - 18000000;
            StadiumPricingStrategy.calculateFees(date5HoursBefore, "2wheelers");
    ...
    it("Check entryTimestamp passed in calculateFees is valid", async () => {
        expect(() => {
            ...
            // const stadiumPricing = new StadiumPricingStrategy();
            const date5HoursBefore = `${Date.now() - 18000000}`;
            StadiumPricingStrategy.calculateFees(date5HoursBefore, VehicleCategory[0]);
